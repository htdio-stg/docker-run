# 🚀 IaC Templates for alist

> View deploy stats for alist in [DeployStack catalog](https://deploystack.io/c/alistgo-alist)
...
| Helm | `helm repo add htdiostg https://htdio-stg.github.io/deploy-templates/`<br>`helm repo update`<br>`helm install alist htdiostg/alistgo-alist` |

## 📦 IaC templates

- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/deploystackio/deploy-templates/tree/main/alistgo-alist) repository.
