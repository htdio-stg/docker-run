...
- IaC templates are stored within the [deploystackio/deploy-templates](https://github.com/htdio-stg/deploy-templates/tree/main/djalal-quran-mcp-server) repository.
